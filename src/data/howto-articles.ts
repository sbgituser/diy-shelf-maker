    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "ウレタンニス仕上げは正解で、コンロ横の油はねも濡れ布巾で拭くだけで綺麗になります。改善点としては、棚板を固定式にしたため調味料のサイズが変わると配置に悩むことです。次に作るなら、側板にダボ穴を等間隔で開けて棚板を可動式にすると柔軟性が上がります。また、最下段にキャスター付きの引き出しトレーを追加すれば、奥の調味料も取り出しやすくなるでしょう。",
        ],
      },
      {
        heading: "同じように作りたい方へのアドバイス",
