...
export const HOWTO_ARTICLES: HowtoArticle[] = [
  ...
  },
  {
    ...
    faq: [
      {
        q: "耐荷重計算の結果はどのくらい正確？",
        a: "材料力学の公式に基づいた計算なので、理論値としては正確です。ただし木材の個体差（節の有無、乾燥状態）があるため、実際の耐荷重は±20%程度のばらつきがあります。安全マージン1.5倍を守れば問題ありません。",
      },
      {
        q: "棚板がたわんでしまった場合の対処法は？",
        a: "軽度のたわみなら、荷物を一度降ろして中間に支柱を追加するか、棚板の裏側に補強用の角材をビスで固定します。ひどいたわみは棚板を交換し、より厚い板や強度の高い素材に変更しましょう。",
      },
      {
        q: "本棚を作りたいけど何kgまで載せられる？",
        a: "一般的な構成（パイン集成材18mm厚、幅600mm）なら1段あたり約15kg、文庫本で約100冊、漫画で約75冊が目安です。[耐荷重計算ツール](/tools/shelf-load-calc) で自分の設計に合わせた正確な値を確認してください。",
      },
      {
        q: "アジャスター（ラブリコ等）の耐荷重と棚板の耐荷重は別？",
        a: "はい、別の指標です。アジャスターの耐荷重は柱1本にかかる総荷重の上限、棚板の耐荷重は棚板1枚に載せられる重量の上限です。両方を確認して、低い方を基準に設計してください。",
      },
    ],
    relatedTemplates: ["bookshelf", "wallist-heavy-shelf", "labrico-wall-storage"],
    primaryTemplate: "bookshelf",
    primaryCta: "耐荷重を考慮した棚を設計",
    amazonLinks: [
  ...
  },
  {
    ...
    title:
      "ラブリコ・ディアウォール・ウォリスト徹底比較ツール！最適なアジャスターの選び方",
    description:
      "突っ張り棚のアジャスターを比較検討できるツールの使い方ガイド。ラブリコ、ディアウォール、ウォリストの耐荷重・価格・使いやすさを一目で比較。あなたの用途に最適な製品が見つかります。",
    icon: "🔧",
    publishedAt: "2026-04-07",
    keywords: [
    ...
    faq: [
      {
        q: "ラブリコとディアウォール、どちらが初心者向き？",
        a: "取り付けの手軽さではディアウォールですが、微調整のしやすさと固定力からラブリコの方が失敗しにくいです。総合的には初心者にラブリコをおすすめします。[比較ツール](/tools/support-system-picker) で詳しいスペックを確認してみてください。",
      },
      {
        q: "アジャスターを後から別のブランドに変更できる？",
        a: "可能ですが、カット寸法が変わるため木材の再カットが必要になる場合があります。例えばディアウォール（-45mm）からラブリコ（-95mm）に変更すると、木材が50mm長すぎる計算になります。変更を見越すなら短い方に合わせてカットし、不足分はスペーサーで補う方法もあります。",
      },
      {
        q: "賃貸の石膏ボード天井でも使える？",
        a: "はい、3ブランドとも天井と床で突っ張るだけなので、釘やネジで穴を開ける必要はありません。ただし天井裏に下地（梁や野縁）がある場所に設置するとより安定します。下地の位置は下地センサー（1,000円程度）で簡単に確認できます。",
      },
      {
        q: "3つのブランドを混ぜて使っても大丈夫？",
        a: "技術的には可能ですが、カット寸法が異なるため同じ棚の柱で混在させるのはおすすめしません。別の棚で異なるブランドを使い分ける（例：本棚はラブリコ、飾り棚はディアウォール）のは問題ありません。",
      },
    ],
    relatedTemplates: ["labrico-wall-storage", "diawall-bookshelf", "wallist-heavy-shelf"],
    primaryTemplate: "labrico-wall-storage",
